...
### Paso 2: Crear la Interfaz para Agregar y Buscar Donantes
...
if __name__ == "__main__":
    # Cargar claves para criptografía
    clave_sim = b'clave_aes_simetrica'  # Reemplazar con la clave real
    clave_privada = b'clave_privada_rsa'  # Reemplazar con la clave real
    clave_publica = b'clave_publica_rsa'  # Reemplazar con la clave real
